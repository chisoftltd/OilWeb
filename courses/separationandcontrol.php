...
<head>
    <meta charset="utf-8">
    <title>OilWeb | Oil and Gas Separation Course</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/index.php">OilWeb | Oil and Gas Separation course</a>
            </div>
...
<section>
    <div class="container" style="background-color: #b0e0e6">
        <h2>Oil and Gas Separation course coming soon</h2>
    </div>

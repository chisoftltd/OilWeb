...
<section>
    <div class="container">
        <div class="row">
            ...
            <hr>
            <div class="w3-content w3-section" style="max-width:1000px; margin-left:7%; max-height: 500%">
                <img class="mySlides" src="images/drilling.jpg" style="width:100%; height: 100px">
                <img class="mySlides" src="images/control.jpg" style="width:100%; height: 100px">
                <img class="mySlides" src="images/casingcementing.jpg" style="width:100%; height: 100px">
            </div>
